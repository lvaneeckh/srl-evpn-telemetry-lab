...
# & => run in background
#iperf3 -c 192.168.1.20 -t 10000 -i 1 -p 5202 -B 192.168.1.10 -P 8 -b 200K -M 1460 &
iperf3 -c 2002::172:17:0:2 --bidir -t 10000 -i 1 -p 5221 -B 2002::172:17:0:1 -P 8 -b 200K -M 1460 &