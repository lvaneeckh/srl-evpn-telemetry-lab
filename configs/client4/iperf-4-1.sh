...
# & => run in background
#iperf3 -c 192.168.1.10 -t 10000 -i 1 -p 5201 -B 192.168.1.40 -P 8 -b 200K -M 1460 &
iperf3 -c 2002::172:17:0:1 --bidir -t 10000 -i 1 -p 5214 -B 2002::172:17:0:4 -P 8 -b 200K -M 1460 &