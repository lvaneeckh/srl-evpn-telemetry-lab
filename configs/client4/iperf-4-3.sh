...
# & => run in background
#iperf3 -c 192.168.1.30 -t 10000 -i 1 -p 5203 -B 192.168.1.40 -P 8 -b 200K -M 1460 &
iperf3 -c 2002::172:17:0:3 --bidir -t 10000 -i 1 -p 5234 -B 2002::172:17:0:4 -P 8 -b 200K -M 1460 &